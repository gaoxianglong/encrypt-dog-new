...
package com.gxl.encryptdog.utils.uuid.impl;
...
public class SnowflakeIdWorker implements IdWorker<Long> {
     ...
     */
    private void validate(long idcId, long workerId) throws OperationException {
     ...
     */
    @Override
    public Long getId() throws OperationException {
        validate(idcId, workerId);
