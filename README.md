...
[![License](https://img.shields.io/badge/license-Apache%202-4EB1BA.svg)](https://www.apache.org/licenses/LICENSE-2.0.html) ![License](https://img.shields.io/badge/build-passing-brightgreen.svg) ![License](https://img.shields.io/badge/version-2.0.8--RELEASE-blue)
...
```shell
$ wget https://github.com/gaoxianglong/encrypt-dog-new/releases/download/v2.0.8/EncryptDog-2.0.8.dmg
```
#### jar (also supported)
```shell
$ wget https://github.com/gaoxianglong/encrypt-dog-new/releases/download/v2.0.8/encryptdog-2.0.8.jar
alias dog = 'java -Xms1g -Xmx1g -Xmn384m -jar encryptdog-2.0.8.jar'
```
...
```shell
$ java -Xms1g -Xmx1g -Xmn384m -jar encryptdog-2.0.8.jar --gui
# prefill source files and algorithm
$ java -jar encryptdog-2.0.8.jar --gui -e -a AES -s /path/to/file1,/path/to/file2
```
